...
%En la figura \ref{fig:maquina_estados_sd} se muestra el diseño de la aplicación donde se han definido los siguientes estados. 
%La aplicación de BitCloud para el dispositivo, ver figura \ref{fig:maquina_estados_sd}, se estructura de la siguiente manera: 
